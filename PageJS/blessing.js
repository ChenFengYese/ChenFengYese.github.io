...
//   return flag;
// }
document.getElementById("contact_name").value = $.cookie("contact_name_blessing");
document.getElementById("contact_name2").value = $.cookie("contact_name2_blessing");
document.getElementById("contact_message").value = $.cookie("contact_message_blessing");
document.getElementById("contact_info").value = $.cookie("contact_info_blessing");
